...
/*
 * package 패키지명(소문자);        package java.lang;
 ...
 * 
 * package :
 * 1. 비슷한 작업을 수행하는 및 인터페이스를 묶어서 사용한다.
 * 2. open API에서 제공하는 클래스 : 클래스 및 인터페이스 중복을 피하기 위해서 사용한다.
 * 
 * 		domain : www.gov.kr
 * 		package : kr.gov
 * 
 * import : 외부 클래스 및 인터페이스 위치를 JVM에 알려주기 위해사 사용한다.
 * 
 * 제어자(modifier)
 * 1. 클래스나 변수, 메소드, 생성자의 선언부에 사용되어 부가적인 의미를 부여한다.
